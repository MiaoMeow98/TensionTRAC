...
# Dataset.
_C.TRAIN.DATASET = "tension_clips"
...
# Number of mini-batches/episodes to accumulate before each optimizer step.
...
_C.MODEL.GEM_POOLING_AS_CLS = False
_C.MODEL.GEM_POOLING_P = 3.0
...
# Number of trajectory transformer layers
_C.MF.NUM_LAYERS = 1
...
_C.MODEL.FUSION.TYPE = (
    "add"  # 'concat', 'add', 'cross_fusion', 'self_cross_attention', 'self_attention'
)
_C.MODEL.FUSION.OUTPUT_DIM = None  # if none, determined by fusion type
_C.MODEL.FUSION.SELF_ATTENTION_NUM_HEADS = 4
_C.MODEL.FUSION.SELF_ATTENTION_DROPOUT_RATE = 0.0
_C.MODEL.FUSION.SELF_ATTENTION_USE_FFN = False
_C.MODEL.FUSION.SELF_ATTENTION_USE_POS_ENCODING = False
_C.MODEL.FUSION.SELF_ATTENTION_POS_ENCODING_TYPE = "fixed"
_C.MODEL.FUSION.SELF_ATTENTION_ACROSS_DIM = "spatial"  # "spatial" or "temporal"
_C.MODEL.FUSION.SELF_ATTENTION_POS_ENCODING_ACROSS_DIM = (
    "same"  # "same", "spatial", "temporal", or "both"
)
_C.MODEL.FUSION.CROSS_ATTENTION_NUM_HEADS = 4
_C.MODEL.FUSION.CROSS_ATTENTION_NUM_LAYERS = 2
_C.MODEL.FUSION.CROSS_ATTENTION_USE_FFN = False
_C.MODEL.FUSION.CROSS_ATTENTION_ALONG_DIM = "spatial"
_C.MODEL.FUSION.GATED_FUSION_HIDDEN_DIM = 128
_C.MODEL.FUSION.GATED_FUSION_OUTPUT_DIM = 768
_C.MODEL.FUSION.FINAL_FUSION_TYPE = "concat"  # 'concat' or 'gated_softmax_fusion'
_C.MODEL.FUSION.SELF_CROSS_ATTENTION_USE_FFN = False
_C.MODEL.FUSION.SEMANTIC_FUSION_DIM = 0
